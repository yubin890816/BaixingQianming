...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__FADCE7A",
    appName: "BaixingQianming",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/explain-result/explain-result",
    style: {
      navigationBarTitleText: ""
    }
  },
  ...
  list: [
    {
      ...
      selectedIconPath: "static/tabbar/tj-a.png",
      text: "起名"
    },
    {
      pagePath: "pages/explain/explain",
      iconPath: "static/tabbar/bg.png",
      selectedIconPath: "static/tabbar/bg-a.png",
      text: "解名"
    },
    {
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.1.8"\n    ],\n    "debugPort": 9001,\n    "initialLaunchType": "local",\n    "servePort": 7001,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/tools/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"znjk","spaceId":"mp-39abcf1b-9e01-4720-8432-5bef3f2b2f84","clientSecret":"OOfajvnBVK6qSsvccPiaWQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__FADCE7A";
} catch (e2) {
